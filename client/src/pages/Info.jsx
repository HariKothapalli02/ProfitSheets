...
const CONTENT = {
  '/about': {
    title: 'About IndiaSphere',
    subtitle: 'Enterprise-grade financial news and analysis platform.',
    body: `
      <p>IndiaSphere is a premier stock market news and financial intelligence platform designed for modern investors, traders, and financial professionals.</p>
      ...
      <p>Built with speed, reliability, and security in mind, IndiaSphere offers a clean, trustworthy, and clutter-free interface to keep you ahead in the financial markets.</p>
    `
  },
  '/contact': {
    title: 'Contact Us',
    ...
    body: `
      ...
      <div style="margin: 24px 0; display: flex; flex-direction: column; gap: 12px;">
        <p>📧 <strong>Email Support:</strong> support@indiasphere.com</p>
  ...
  '/privacy': {
    ...
    body: `
      <p>At IndiaSphere, we take your privacy seriously. This policy outlines how we collect, use, and protect your information:</p>
      <ul>
  ...
  '/terms': {
    ...
    body: `
      <p>By accessing or using IndiaSphere, you agree to comply with the following terms:</p>
      <ul>
        <li><strong>Information Only:</strong> All content published on IndiaSphere is for informational purposes only. It does not constitute financial, legal, or investment advice.</li>
